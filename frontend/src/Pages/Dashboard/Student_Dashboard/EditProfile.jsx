...
function EditProfile() {
  ...
  return (
    <div className='flex flex-col lg:mt-0 mt-10'>
        {loading && <Spinner/>}
        <div className='lg:ml-10 ml-4 mt-4 cursor-pointer flex gap-1 items-center' onClick={()=>navigate("/student-dashboard/profile")}>
      ...
      <div className='flex flex-col lg:ml-36 ml-4 lg:mt-10 mt-4  h-full gap-4'>
        ...
        <div className='bg-[#21293a] py-4 lg:w-[650px] flex justify-between items-center lg:px-6 px-4  rounded-md'>
            ...
            <div className='flex gap-4 items-center'>
                ...
                <div className="w-[75px]  rounded-full  ">
                    ...
                    <img src={profileImage} alt="" className='rounded-full  w-[70px] h-[70px]'  />
                ...
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='flex lg:flex-row flex-col lg:gap-0 gap-6 justify-between lg:items-center '>
                        ...
                        <div className='flex flex-col gap-2 items-start lg:w-[45%] '>
                            ...
                            <input {...register("dateOfBirth",{required:true})} type="date" name='dateOfBirth' id='dateOfBirth'  className='px-3 rounded-md py-2 bg-[#3d424e] text-[#cdd4e1] outline-none w-full' />
                    ...
                    <div className='flex lg:flex-row flex-col lg:gap-0 gap-6 justify-between lg:items-center '>
                        <div className='flex flex-col gap-2 items-start lg:w-[45%]'>
                            ...
                            <div className='flex gap-2'>
                                ...
                                <div className='flex flex-col'>
                                    <input type="text" name='phoneNumber' {...register("phoneNumber",{required:true})} id='phoneNumber' placeholder='Enter phone Number..' className='px-3 rounded-md py-2 bg-[#3d424e] text-[#cdd4e1] outline-none w-full' />
        ...
        <div className='bg-[#21293a]  lg:h-[190px] lg:w-[650px] px-6 py-6 flex gap-4 flex-col rounded-md mb-12'>
                    ...
                    <div className='flex sm:gap-3 gap-3  mt-4 justify-end'>
                        ...
                        <button onClick={()=>navigate("/student-dashboard/profile")} className='bg-[#3d424e] text-white sm:px-5 px-4 py-2 rounded-lg font-semibold '>Cancel</button>
